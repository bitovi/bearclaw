/*
  ...
  - Added the required column `accountStatus` to the `OrganizationUsers` table without a default value. This is not possible if the table is not empty.
